...
# PREDICT
echo "predict gpner"
python -u code_main/pyrun_gpner.py --do_predict --finetuned_model_name 'gpner' --data_dir ${data_dir} --method_name ${method_name} --model_version ${version1} --devices ${gpu} --with_type --model_type ${model_type} --pretrained_model_name ${pretrained_model_name}

echo "predict gpner9"
python -u code_main/pyrun_gpner.py --do_predict --finetuned_model_name 'gpner9' --data_dir ${data_dir} --method_name ${method_name} --model_version ${version2} --devices ${gpu} --with_type --model_type ${model_type} --pretrained_model_name ${pretrained_model_name}
...
python -u code_main/pyrun_gpfilter.py --do_filter --data_dir ${data_dir} --method_name ${method_name} --model_version ${version3} --model_version_1 ${version1} --model_version_2 ${version2} --devices ${gpu} --with_type --model_type ${model_type} --pretrained_model_name ${pretrained_model_name}
